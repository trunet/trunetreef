...
FLASH_SIZE=1048576
FLASH_USED=`$DU -b $BUILD_DIR/trunetreef.bin | gawk '{print$1}'`

RAM_SIZE=`cat $BUILD_DIR/trunetreef.map | grep "__ram_size__ =" | gawk '{print$1}'`
RAM_USED=`arm-none-eabi-size $BUILD_DIR/trunetreef.elf | tail -1 | awk '{print $2+$3}'`
